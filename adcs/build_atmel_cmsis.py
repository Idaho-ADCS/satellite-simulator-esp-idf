...
env.Append(
    CPPPATH=[
        ...
        join(atmel_cmsis_dir, "CMSIS", "Device", "ATMEL",
             "samd51", "include"),  # conviennce for our chip
...
system_file_dir = join(atmel_cmsis_dir, "CMSIS",
                       "Device", "ATMEL", "samd51", "source")
system_file_dir_filter = "-<*> +<system_samd51.c> +<as_gcc/startup_samd51.c>"
env.BuildSources(join("$BUILD_DIR", "FrameworkCMSIS"),
                 system_file_dir, src_filter=system_file_dir_filter)
