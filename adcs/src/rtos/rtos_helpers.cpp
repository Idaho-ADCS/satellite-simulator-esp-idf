...
// #endif
...
#if DEBUG
		SERCOM_USB.write("[mode switch]\tEntering ORIENT mode\r\n");
#endif
		break;
	...
	default: // do nothing
		...
		SERCOM_USB.write("[mode switch]\tUnknown command: ");
...
{
#if DEBUG
	SERCOM_USB.write("[rtos]\t\tInitializing RTOS test suite\r\n");
#endif
...
#if DEBUG
	SERCOM_USB.write("[rtos]\t\tCreated basic attitude determination task\r\n");
#endif
...
#if DEBUG
	SERCOM_USB.write("[rtos]\t\tCreated simple orient task\r\n");
#endif

	xTaskResumeAll(); // resume scheduler after tasks are created
#if DEBUG
	SERCOM_USB.write("[rtos]\t\tResumed scheduler\r\n");
#endif

#if DEBUG
	SERCOM_USB.write("[rtos]\t\tInitialized RTOS test suite\r\n");
#endif
}